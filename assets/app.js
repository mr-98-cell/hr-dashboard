...
(function () {
  ...
  const ICONS = {
    ...
    board: '<path d="M4 4h16a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z"/><path d="M12 15v3"/><path d="m8 21 4-3 4 3"/><path d="M7 8h7M7 11h4"/>',
  ...
  function pageIndex() {
    ...
    const cards = [
      ...
      ["tamheer", "board", tamheer.length, "طلبات تمهير"],
  ...
  function shell(title, body) {
    ...
    ["tamheer", "طلبات تمهير", "board"], ["resignations", "الاستقالات", "exit"], ["sectors", "القطاعات", "office"]];
